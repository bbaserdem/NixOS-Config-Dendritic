...
{...}: {
  ...
  in {
    key = "mpd-ncmpcpp#homeManager";
    config = {
      # Placeholder file so the folder is autogenerated
      xdg.dataFile."${cacheSubdir}/.keep".text = "";

      # NCMPCPP settings
      programs.ncmpcpp = {
        enable = true;

        # Build custom features into ncmpcpp
        ...
        settings = {
          ...
          # Tags
          external_editor = config.home.sessionVariables.EDITOR or "nvim";
