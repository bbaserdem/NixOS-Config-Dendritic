# Configuring firefox plugins
{...}: {
  flake.modules.home-manager.firefox = {pkgs, ...}: let
  ...
  in {
    ...
    # Need these packages in userspace as well in linux
    home.packages =
      if pkgs.stdenv.hostPlatform.isLinux
      then with pkgs; [vdhcoapp pywalfox-native-with-manifest]
      else [];
  };
}
